...
export function AnnualReportShareClient({ token }: { token: string }) {
  ...
  return <section className="panel"><span className="eyebrow">麻麻抱我 · 年度报告</span><h1>{data.year} 年度报告</h1><Image src={data.previewUrl} alt="年度报告预览" width={1080} height={1920} sizes="100vw" style={{ width: "100%", height: "auto" }} unoptimized /><p>这是一份只读预览，不展示原始照片。</p></section>;
}
